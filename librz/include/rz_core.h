...
typedef struct rz_core_string_t {
	...
	ut32 length;
	/**
	 * A string type - ASCII, Wide, or various Unicode types.
	 */
	RzCoreStringType type;
	/**
...
RZ_API RZ_OWN RzCoreString *rz_core_string_information(RzCore *core, const char *block, int len, RzCoreStringType type);
